...
@section('content')
    <h1 class="font-bold capitalize text-4xl">Update Role</h1>
    <br>
    <br><br>
    <hr><br><br>
    <a href="/role/index"
    ...
    <form action="/role/update" method="POST">
        ...
        <div class="mb-6">
            <label for="role_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Role
                Name</label>
            <input type="text" id="role_name" name="role_name" value="{{ $roleedit['role_name'] }}"
