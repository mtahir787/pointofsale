...
@section('content')
    <h1 class="font-bold capitalize text-4xl">Detail of Role</h1>
    <br>
    <br><br>
    <hr><br>
    <a href="/role/index"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        {{ $roleitemdetail['category_name'] }}
                    </td>
                    <td class="px-6 py-4">
                        <a href={{ '/role/details/' . $roleitemdetail['id'] }}
                        ...
                        <a href={{ '/role/edit/' . $roleitemdetail['id'] }}
                        ...
                        <a href={{ '/role/trash/' . $roleitemdetail['id'] }}
