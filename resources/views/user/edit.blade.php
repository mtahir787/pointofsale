...
@section('content')
    <h1 class="font-bold capitalize text-4xl">Update User</h1>
    <br>
    <hr><br>
    <a href="/user/index"
    ...
    <form action="/user/update" method="POST" class="mb-32">
        @csrf
        <div class="mb-6 hidden">
            <label for="user_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">User
                ID</label>
            <input type="text" id="user_id" value="{{ old('user_id') ? old('user_id') : $useredit['0']->id }}"
                name="user_id"
        ...
        <div class="mb-6">
            ...
            <input type="text" id="user_name"
                value="{{ old('user_name') ? old('user_name') : $useredit['0']->fullname }}" name="user_name"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Enter User Name" required="">
        </div>
        <div class="mb-6">
            ...
            <input type="text" id="user_email"
                value="{{ old('user_email') ? old('user_email') : $useredit['0']->email }}" name="user_email"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="mb-6">
            ...
            <input type="text" id="user_contact"
                value="{{ old('user_contact') ? old('user_contact') : $useredit['0']->contact }}" name="user_contact"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="mb-6">
            ...
            <input type="text" id="user_address"
                value="{{ old('user_address') ? old('user_address') : $useredit['0']->address }}" name="user_address"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div class="mb-6">
            ...
            <select id="user_role" name="user_role"
                ...
                @foreach ($roles as $role)
                    ...
                    @elseif($useredit['0']->role_name === $role['role_name'])
                        <option selected value="{{ $role['id'] }}">{{ $role['role_name'] }}</option>
                    @else
